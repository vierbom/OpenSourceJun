...
public abstract class EuclidActivity extends Activity {
    ...
    protected TextView mTextViewEuclidTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewEuclidTitle= (TextView) findViewById(R.id.euclid_title);
    ...
    private void addOverlayListItem(Map<String, Object> item, View view) {
        ...
        SimpleDraweeView i=(SimpleDraweeView) mOverlayListItemView.findViewById(R.id.image_view_reveal_avatar);
        Uri uri = Uri.parse((String)item.get(EuclidListAdapter.KEY_AVATAR));
...
//                .into(i);
        ...
        SimpleDraweeView s=(SimpleDraweeView) mOverlayListItemView.findViewById(R.id.image_view_avatar);
//        Picasso.with(EuclidActivity.this).load((Integer) item.get(EuclidListAdapter.KEY_AVATAR))
//                .resize(sScreenWidth, sProfileImageHeight).centerCrop()
//                .placeholder(R.color.blue)
//                .into((ImageView) mOverlayListItemView.findViewById(R.id.image_view_avatar));
    ...
    private void setProfileDetailsInfo(Map<String, Object> item) {
        ...
        mTextViewProfileDescription.setText((String) item.get(EuclidListAdapter.INTRODUCE));
    }
    ...
    private Animator getOpenProfileDetailsAnimator() {
        return ObjectAnimator.ofFloat(mProfileDetails, View.Y,
